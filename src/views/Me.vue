    ...
    <section class="aui-scrollView">
      ...
      <div class="aui-chang-list">
        <div class="aui-user-img">
          <img :src="$store.state.user.userDetail.data.profile.avatarUrl" alt="无图片">
        </div>
        <div class="aui-user-text">
          <h1>{{ $store.state.user.userDetail.data.profile.nickname }}</h1>
          <span v-if="$store.state.user.userDetail.data.profile.vipType===0"><i class="icon icon-vip" ></i>您还未开通VIP会员</span>
          <span v-else><i class="icon icon-vip" ></i>您是VIP会员</span>
